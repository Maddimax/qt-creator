...
struct Package {
    ...
    QList<Argument> _runtime_arguments;
    QList<Argument> _package_arguments;
    std::optional<QList<KeyValueInput>> _headers;
    QList<KeyValueInput> _env_vars;
    ...
    const QList<Argument>& runtime_arguments() const { return _runtime_arguments; }
    const QList<Argument>& package_arguments() const { return _package_arguments; }
    const std::optional<QList<KeyValueInput>>& headers() const { return _headers; }
    const QList<KeyValueInput>& env_vars() const { return _env_vars; }
};
...
struct Server {
    ...
    const QList<Icon>& icons() const { return _icons; }
    const QList<Package>& packages() const { return _packages; }
    const QList<Remote>& remotes() const { return _remotes; }
};
